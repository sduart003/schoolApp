...
import exceptionhandlers.MissingSalaryException;
    ...
    private void saveData() {
        ...
        try{    
            ...
            try{
                ...
                Application.getLOGGER().info(InputFacultyFormController.class.getName() + " : missing salary exception thrown");
                MissingSalaryException error = new MissingSalaryException();
             }
            ...
            Application.getLOGGER().info(InputFacultyFormController.class.getName() + " : exception thrown saving faculty data");
