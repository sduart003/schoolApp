...
public class InputStudentFormController implements ActionListener {
    ...
    public void saveData() {
        try{
            ...
            try {
                ...
                Application.getLOGGER().info(InputStudentFormController.class.getName() + " : setting GPA");
            } catch (NumberFormatException ex) {
              Application.getLOGGER().info(InputStudentFormController.class.getName() + " : setting default GPA");
              newStudent.setGPA(0);
            } 


        }catch (InvalidDataException | MissingDataException ex){
           Application.getLOGGER().info(InputStudentFormController.class.getName() + " : exception thrown saving student data");
    ...
    private LocalDate getDate(String formStringDate) {
        ...
        try {
            ...
            Application.getLOGGER().info(InputStudentFormController.class.getName() + " : setting default date");
